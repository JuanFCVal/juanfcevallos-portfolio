    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto px-6 text-center">
        ...
        <h2 className="text-3xl md:text-5xl lg:text-6xl font-black leading-tight text-white mb-8 tracking-tight">
          ...
          <span className="text-[#E85D26]">ARCHITECTURAL REALITY.</span>
        </h2>
        ...
        <div className="inline-block">
          <div
            className="relative px-10 py-8 rounded-xl overflow-hidden"
            style={{
              background: "linear-gradient(135deg, #0d1a30 0%, #1e3557 100%)",
              boxShadow: "0 0 60px rgba(232,93,38,0.15), inset 0 1px 0 rgba(255,255,255,0.05)",
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-14 text-left">
          {[
            ...
            <div
              key={item.stat}
              className="p-6 rounded-lg border border-white/10 hover:border-[#E85D26]/40 transition-colors"
