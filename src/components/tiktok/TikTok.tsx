        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {videos.map((video, i) => (
            <AnimateOnScroll key={video.id} animation="fade-up" delay={i * 120}>
              <div
                className="group relative rounded-xl overflow-hidden border border-white/10 hover:border-white/25 transition-all hover:shadow-2xl hover:-translate-y-1 h-full"
